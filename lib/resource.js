...
var Resource = function (_HTTP) {
  ...
  function Resource(name, url, headers) {
    ...
    /*  
        ...
        the response data.
    */
    _this.dispatchAction = function (action, data) {
    ...
    _this.configureState = function (state) {
      _this.state = state;
      return _this;
    };
    /* 
    ...
    */
    ...
    _this.registerNewAction = function (url, name, method, reducerFn) {
    ...
    _this.addResourceAction = function (url, name, method) {
    ...
    //  create a new reducer action (more flexible)
    _this.addReducerAction = function (name, callback) {
      var actionName = _this.prefix + name;
    ...
    _this.updateReducerAction = function (name, callback) {
      var actionName = _this.prefix + name;
    ...
    _this.updateResourceAction = function (name, callback) {
      var actionName = _this.prefix + name;
      _this.reducerActions[actionName] = callback;
      return _this;
    };
    ...
    */
    _this.registerDefaults = function () {
